...
public:
	...
	HD_UI_Button(char *objectName, int index, char *standardImageName, char *atlasName, char *tooltip,
	...
	HD_UI_Button(char *objectName, int index, char *caption, char *tooltip, float fX, float fY,
	...
	HD_UI_Button(char *objectName, int index, char *caption, char *tooltip, float fX, float fY,	float fWidth, float fHeight,
