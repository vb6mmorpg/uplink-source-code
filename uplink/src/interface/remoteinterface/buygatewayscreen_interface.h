...
#ifndef _included_buygatewayscreeninterface_h
#define _included_buygatewayscreeninterface_h
...
class BuyGatewayScreenInterface : public RemoteInterfaceScreen
{
