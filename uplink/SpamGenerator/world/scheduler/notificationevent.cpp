...
void NotificationEvent::SendSpam ()
{
	...
	duedate.AdvanceHour(NumberGenerator::RandomNumber(RANDOM_TIME_NEXT_SPAM) + MIN_TIME_NEXT_SPAM); // 8-32 hours by default
	duedate.AdvanceMinute( NumberGenerator::RandomNumber(60) );	// Shuffle the minutes around at random
