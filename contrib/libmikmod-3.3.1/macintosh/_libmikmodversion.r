...
#define LIBMIKMOD_VERSION_MINOR			2
#define LIBMIKMOD_REVISION				0

#define LIBMIKMOD_VERSION_STRING 		"3.2.0"

#if 0
	#define LIBMIKMOD_STATE	    			beta		/* development | alpha | beta | release */
	#define LIBMIKMOD_RELEASE_NO     		0			/* number after letter, or zero for release */
#else
	#define LIBMIKMOD_STATE					release
	#define LIBMIKMOD_RELEASE_NO			0
#endif
...
/*	nice custom icon for extension, drawn by Anders F Bjšrklund, follows: */
